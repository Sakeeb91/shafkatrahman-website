...
| Problem/Challenge | Proposed Solution/Approach |
| --- | --- |
| Fleeting and unreliable stimuli in the environment | Persistence of affective states |
| Temporal credit assignment problem | Temporal difference learning, dopamine system |
| Need for exploration and learning | Curiosity, intrinsic motivation |
| Energy management during stress | Acute stress response |
